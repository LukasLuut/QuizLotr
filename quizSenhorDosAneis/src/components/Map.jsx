...
export function MovingCharacter({ ativo, startZoom = 0.2, endZoom = -1, onMoving, onFinish, onStart }) {
  ...
  const paths = [
    ...
    [[3185, 1485],[3185, 1485], [3133, 1497], [3110, 1544], [3126, 1614],
    [3169, 1674], [3158, 1752], [3182, 1797], [3182, 1797]], // 1 - bri

    [[3182, 1797],[3182, 1797], [3218, 1832], [3196, 1906], [3217, 1977],
    [3210, 2058], [3160, 2109], [3179, 2184], [3191, 2255],
    [3234, 2315], [3230, 2388], [3225, 2445], [3215, 2517], [3215, 2517]], // 2 - rivendell

    [[3215, 2517],[3215, 2517], [3167, 2512], [3120, 2502], [3078, 2488],
    [3033, 2468], [2987, 2453], [2915, 2429], [2788, 2413], [2788, 2413]], // 3 - moria

    [[2788, 2413],[2788, 2413], [2783, 2477], [2770, 2544], [2728, 2595],
    [2689, 2642], [2656, 2715]], // 4 - lorien

    [[2656, 2715],[2656, 2715], [2600, 2781], [2531, 2804], [2462, 2904],
    [2447, 2957], [2392, 2935], [2350, 2957], [2364, 3028],
    [2324, 3033], [2279, 2995], [2247, 3060], [2211, 3058],
    [2132, 3022], [2026, 3044], [1981, 3076], [1981, 3076]], // 5 - argonath

    [[1981, 3076],[1981, 3076], [2028, 3121], [2071, 3202], [2033, 3285],
    [1975, 3367], [1975, 3367]], // 6 - mordorEntrance

    [[1975, 3367],[1975, 3367], [1975, 3367], [1917, 3442], [1872, 3487], [1823, 3512],
    [1747, 3497], [1718, 3543], [1748, 3622], [1748, 3622]], // 7 - mordor
  ];
